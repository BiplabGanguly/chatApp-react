...
function Signin() {
    ...
    function signindata() {
        ...
        console.log(data)
        if (password === cpass && email !== "" && username !== "" && password !== "") {
    ...
    return (
        <div>
            <div className='container login-container'>
                <div className="row login-row"><h2>signin</h2></div>
                {note}
                ...
                <div className="row login-row">
                    <div className="col-md-4 offset-md-4">
                        <button type='button'
                            ...
                            onClick={signindata}>signin</button>
                    </div>
                </div>

                <span className='login-text'>back to <Link to="/" className='login-link'>login</Link></span>
